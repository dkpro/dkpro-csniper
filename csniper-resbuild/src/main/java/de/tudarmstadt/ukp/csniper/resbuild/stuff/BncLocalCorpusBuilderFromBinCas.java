 ...
 */
public class BncLocalCorpusBuilderFromBinCas
{
	...
	private static final String OUTPUT_SER_CAS_PATH = HADOOP_USER_HOME + "/" + COLLECTION_ID + "/serialized/";
	private static final String OUTPUT_CSV_PATH = HADOOP_USER_HOME + "/" + COLLECTION_ID + "/csv/";
		...
		throws ResourceInitializationException
	{
		...
		return createAggregateDescription(rn, sp, scw, csvw);
	}

	public static void main(String[] args)
	{
		try {
			AnalysisEngineDescription bla = createPrimitiveDescription(CasFlusher.class);
			SimplePipeline.runPipeline(buildCollectionReader(), buildMapperEngine(), bla);
		}
		catch (Exception e) {
			e.printStackTrace();
		}
